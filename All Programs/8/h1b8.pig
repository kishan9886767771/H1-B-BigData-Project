...
h1b = load '/home/hduser/h1b' using PigStorage('\t') as (s_no:int,case_status:chararray, employer_name:chararray, soc_name:chararray, job_title:chararray, full_time_position:chararray,prevailing_wage:int,year:chararray, worksite:chararray, longitute:double, latitute:double); 
...
h1b_union = union h1b_order_y,h1b_order_n;
dump h1b_union;
--store h1b_union into '/home/hduser/8out' using PigStorage(','); 
